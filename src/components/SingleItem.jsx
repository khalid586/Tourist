...
<div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <img className='w-full rounded-t-lg' style={{ height:'280px'}} src = {photoUrl} alt="" />
    <div class="p-5">
        ...
        <div className='flex gap-2 mt-6 mb-4'>
            {
                ...
                <div className='flex justify-evenly w-full'>
                    <Link to ={ `/update/${place._id}`} class="inline-flex gap-2 items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-400 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
